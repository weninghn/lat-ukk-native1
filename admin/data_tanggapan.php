...
<body>
    <div class="mt-4" style="margin-left:3%">
        <h3>Data Pengaduan Yang Sudah Ditanggapi</h3>
        <button class="btn btn-default"><a href="../admin/laporan_tanggapan.php">Cetak Data Tanggapan Pengaduan Masyarakat</a></button><br/><br/>
        <table class="table">
            <thead>
                <tr>
                    <td>No</td>
