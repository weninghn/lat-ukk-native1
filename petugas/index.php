                ...
                <tr>
                    ...
                    <td>
                        <form action="" method="post">
                            ...
                            <a href="../petugas/tanggapan.php?id_pengaduan=<?= $id_pengaduan ?>">Tanggapan</a> | 
                            <a href="../petugas/update.php?id_pengaduan=<?= $id_pengaduan ?>">Edit</a> | 
                            <a href="hapus.php?id_pengaduan=<?= $id_pengaduan ?>">Delete</a>
                        </form>
                    </td>
                </tr>
                <?php
